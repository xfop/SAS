...
function App() {
  ...
  async function handleParse() {
    ...
    try {
      const data = await parseFiles(timetableFile, recordFile);
      setParseResult(data);
    } catch (err) {
  ...
  async function handleGenerate() {
    ...
    try {
      const data = await generateSchedules(timetableFile, recordFile);
